...
/share/lab_teng/trainee/JingjingWu/EBV/HiC_performance/HiC-Pro/bin/HiC-Pro -c config-hicpro.txt -i $RAW_DATA -o hicpro_mapping_2 -s mapping -s quality_checks -p
...
/share/lab_teng/data/software/HiC-Pro_3.1.0/bin/HiC-Pro -i ${MAP_DATA}/proc_hic_out/hic_results/data -o ${MAP_DATA}/merge_validpairs -c ${MAP_DATA}/config-hicpro.txt -s merge_persample -p

# Step 4: HiC-Pro build_contact_maps and ice_norm commands 
/share/lab_teng/data/software/HiC-Pro_3.1.0/bin/HiC-Pro -i ${MAP_DATA}/merge_validpairs/hic_results/data -o ${MAP_DATA}/contact_maps -c ${MAP_DATA}/config-hicpro.txt -s build_contact_maps -s ice_norm -p
